...
public:
	...
	static void AddBox(const string& tag, const glm::vec3& min, const glm::vec3& max, const glm::vec4& color);
	...
	static void AddWiredBox(const string& tag, const glm::vec3& min, const glm::vec3& max, const glm::vec4& color);
