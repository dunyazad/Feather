...
public:
	...
	static void AddBox(const string& tag, const glm::vec3& center, const glm::vec3& dimensions, const glm::vec4& color);
	...
	static void AddWiredBox(const string& tag, const glm::vec3& center, const glm::vec3& dimensions, const glm::vec4& color);
	...
	static void AddSphere(const string& tag, const glm::vec3& center, float radius, const glm::vec4& color);
