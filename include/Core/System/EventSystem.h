...
public:
	...
	void SubscribeEvent(EventType eventType, EventReceiver* eventReceiver);
	void UnsubscribeEvent(EventType eventType, EventReceiver* eventReceiver);

	void DispatchEvent(const Event& event);

private:
	static vector<EventSystem*> s_instances;
	unordered_map<EventType, set<EventReceiver*>> eventReceivers;
